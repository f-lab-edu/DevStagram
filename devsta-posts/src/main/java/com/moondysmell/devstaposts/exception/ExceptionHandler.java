...
public class ExceptionHandler {
    ...
    @ResponseBody
    @org.springframework.web.bind.annotation.ExceptionHandler(PostsException.class)
    public ResponseEntity<Error> exception(PostsException exception){
    ...
    static class Error{
        ...
        static Error create(ExceptionType exception){
